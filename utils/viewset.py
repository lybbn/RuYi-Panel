...
from utils.customView import check_security_path_authed
...
class CustomModelViewSet(ModelViewSet):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if hasattr(self, method_name) and self.check_security_path:
            method = getattr(self, method_name)
            if callable(method):
                self._original_method = method
                setattr(self, method_name, check_security_path_authed(method))
