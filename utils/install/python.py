...
import os,platform
import time
from utils.common import ReadFile,GetTmpPath,GetInstallPath,WriteFile,DeleteFile,GetLogsPath,RunCommandReturnCode,RunCommand,ConvertToUnixLineEndings,CreateInstallProcess,CleanupInstallProcess,SafeReadStderr,ReleaseMemory
...
def get_python_path_info(version):
    ...
    install_abspath_path = os.path.join(root_abspath_path,'python',version)
    install_path = root_path+'/python/'+version
    return {
